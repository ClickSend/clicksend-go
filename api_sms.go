 ...
 * @param optional nil or *SmsInboundReadPutOpts - Optional Parameters:
     * @param "DateBefore" (optional.String) -  An optional timestamp - mark all as read before this timestamp. If not given, all messages will be marked as read.

@return string
*/

type SmsInboundReadPutOpts struct { 
	DateBefore optional.String
}
 ...
 * @param optional nil or *SmsReceiptsReadPutOpts - Optional Parameters:
     * @param "DateBefore" (optional.String) -  Mark all as read before this timestamp
