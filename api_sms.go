...
/* 
SMSApiService Mark specific delivery receipt as read
...
@return string
*/
func (a *SMSApiService) SmsReceiptReadByMessageIdPut(ctx context.Context, messageId string) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sms/receipts-read/{message_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"message_id"+"}", fmt.Sprintf("%v", messageId), -1)
